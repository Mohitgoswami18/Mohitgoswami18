...
<!-- TYPING SUBTITLE -->
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&pause=1000&color=58A6FF&center=true&vCenter=true&width=520&lines=Full-Stack+Developer+(MERN);Building+AI-Powered+Tools;DSA+in+C%2B%2B;Open+to+Remote+Roles+Worldwide" alt="Typing SVG" />
</p>
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/DSA-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white" />
  <img src="https://img.shields.io/badge/ML%20Concepts-Python-3776AB?style=flat-square&logo=python&logoColor=white" />
...
> Applying to internships is repetitive, time-consuming, and broken. Vyom fixes that.

Vyom is an AI-powered agent that reads job listings, fills applications, and personalises cover letters — so you spend time preparing for interviews, not copy-pasting your resume for the 40th time.

**What makes it interesting:**
- Agent architecture that parses job descriptions and matches them against a user's profile
- Auth via Clerk, REST APIs, and a MongoDB-backed user data model
- React + Tailwind frontend with a Node/Express + FastAPI dual backend
